...
setEnv("SERVER_CONFIG_PATH", process.env.MIRAKURUN_HOME + "/config/server.yml");
setEnv("TUNERS_CONFIG_PATH", process.env.MIRAKURUN_HOME + "/config/tuners.yml");
setEnv("CHANNELS_CONFIG_PATH", process.env.MIRAKURUN_HOME + "/config/channels.yml");
setEnv("SERVICES_DB_PATH", process.env.MIRAKURUN_HOME + "/db/services.json");
setEnv("PROGRAMS_DB_PATH", process.env.MIRAKURUN_HOME + "/db/programs.json");
